                                             ...
                                             ? (0xffULL 
                                                ...
                                                (0x38U 
                                                 & ((IData)(vlTOPp->rvcpu__DOT__Exe_stage__DOT__RamReadAddrM_clk_diff__DOT__qout_r) 
                                                    << 3U)))
                                             : 0ULL))));
        vlTOPp->RamWriteData = ((1U & (IData)(vlTOPp->rvcpu__DOT__Exe_stage__DOT__memFuncM_clk_diff__DOT__qout_r))
...
void Vrvcpu::_ctor_var_reset(Vrvcpu* self) {
    ...
    self->rvcpu__DOT__flushE = VL_RAND_RESET_I(1);
    self->rvcpu__DOT__instTypeM = VL_RAND_RESET_I(10);
    self->rvcpu__DOT__LoadRedirect = VL_RAND_RESET_I(2);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        self->rvcpu__DOT____Vcellout__Regfile__regs_o[__Vi0] = VL_RAND_RESET_Q(64);
    }
    self->rvcpu__DOT__stallF = VL_RAND_RESET_I(1);
    self->rvcpu__DOT__stallD = VL_RAND_RESET_I(1);
    self->rvcpu__DOT__stallE = VL_RAND_RESET_I(1);
    ...
    self->rvcpu__DOT__Id_stage__DOT__instE_dff__DOT__qout_r = VL_RAND_RESET_I(32);
    ...
    self->rvcpu__DOT__Exe_stage__DOT__jumpAddr_dff__DOT__qout_r = VL_RAND_RESET_Q(64);
    ...
    self->rvcpu__DOT__Exe_stage__DOT__instM_dff__DOT__qout_r = VL_RAND_RESET_I(32);
    self->rvcpu__DOT__Exe_stage__DOT__pcM_dff__DOT__qout_r = VL_RAND_RESET_Q(64);
    self->rvcpu__DOT__Mem_stage__DOT__loadRes8 = VL_RAND_RESET_Q(64);
    ...
    self->rvcpu__DOT__Mem_stage__DOT__instW_dff__DOT__qout_r = VL_RAND_RESET_I(32);
    self->rvcpu__DOT__Mem_stage__DOT__pcW_dff__DOT__qout_r = VL_RAND_RESET_Q(64);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        self->rvcpu__DOT__Regfile__DOT__regs[__Vi0] = VL_RAND_RESET_Q(64);
    }
    self->rvcpu__DOT__Ctrl__DOT__Redirect1_r = VL_RAND_RESET_I(2);
    self->rvcpu__DOT__Ctrl__DOT__flushC = VL_RAND_RESET_I(1);
    ...
    self->rvcpu__DOT__Wb_stage__DOT__rdWriteEnableO_clk_diff__DOT__qout_r = VL_RAND_RESET_I(1);
    self->rvcpu__DOT__Wb_stage__DOT__rdWriteAddrO_clk_diff__DOT__qout_r = VL_RAND_RESET_I(5);
    self->rvcpu__DOT__Wb_stage__DOT__rdWriteDataO_clk_diff__DOT__qout_r = VL_RAND_RESET_Q(64);
    self->rvcpu__DOT__Wb_stage__DOT__instO_dff__DOT__qout_r = VL_RAND_RESET_I(32);
    self->rvcpu__DOT__Wb_stage__DOT__pcO_dff__DOT__qout_r = VL_RAND_RESET_Q(64);
