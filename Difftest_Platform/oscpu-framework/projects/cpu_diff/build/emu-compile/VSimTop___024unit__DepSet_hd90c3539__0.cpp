...
extern "C" void v_difftest_ArchEvent(char coreid, int intrNo, int cause, long long exceptionPC, long long exceptionInst);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_ArchEvent_TOP____024unit(CData/*7:0*/ coreid, IData/*31:0*/ intrNo, IData/*31:0*/ cause, QData/*63:0*/ exceptionPC, QData/*63:0*/ exceptionInst) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_ArchEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
...
extern "C" void v_difftest_InstrCommit(char coreid, char index, svBit valid, long long pc, int instr, svBit skip, svBit isRVC, svBit scFailed, svBit wen, char wdest, long long wdata);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_InstrCommit_TOP____024unit(CData/*7:0*/ coreid, CData/*7:0*/ index, CData/*0:0*/ valid, QData/*63:0*/ pc, IData/*31:0*/ instr, CData/*0:0*/ skip, CData/*0:0*/ isRVC, CData/*0:0*/ scFailed, CData/*0:0*/ wen, CData/*7:0*/ wdest, QData/*63:0*/ wdata) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_InstrCommit_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
    char index__Vcvt;
...
VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_TrapEvent_TOP____024unit(CData/*7:0*/ coreid, CData/*0:0*/ valid, CData/*7:0*/ code, QData/*63:0*/ pc, QData/*63:0*/ cycleCnt, QData/*63:0*/ instrCnt) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_TrapEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
    svBit valid__Vcvt;
...
extern "C" void v_difftest_CSRState(char coreid, char priviledgeMode, long long mstatus, long long sstatus, long long mepc, long long sepc, long long mtval, long long stval, long long mtvec, long long stvec, long long mcause, long long scause, long long satp, long long mip, long long mie, long long mscratch, long long sscratch, long long mideleg, long long medeleg);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_CSRState_TOP____024unit(CData/*7:0*/ coreid, CData/*7:0*/ priviledgeMode, QData/*63:0*/ mstatus, QData/*63:0*/ sstatus, QData/*63:0*/ mepc, QData/*63:0*/ sepc, QData/*63:0*/ mtval, QData/*63:0*/ stval, QData/*63:0*/ mtvec, QData/*63:0*/ stvec, QData/*63:0*/ mcause, QData/*63:0*/ scause, QData/*63:0*/ satp, QData/*63:0*/ mip, QData/*63:0*/ mie, QData/*63:0*/ mscratch, QData/*63:0*/ sscratch, QData/*63:0*/ mideleg, QData/*63:0*/ medeleg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_CSRState_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
...
extern "C" void v_difftest_StoreEvent(char coreid, char index, svBit valid, long long storeAddr, long long storeData, char storeMask);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_StoreEvent_TOP____024unit(CData/*7:0*/ coreid, CData/*7:0*/ index, CData/*0:0*/ valid, QData/*63:0*/ storeAddr, QData/*63:0*/ storeData, CData/*7:0*/ storeMask) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_StoreEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
    char index__Vcvt;
...
extern "C" void v_difftest_LoadEvent(char coreid, char index, svBit valid, long long paddr, char opType, char fuType);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_LoadEvent_TOP____024unit(CData/*7:0*/ coreid, CData/*7:0*/ index, CData/*0:0*/ valid, QData/*63:0*/ paddr, CData/*7:0*/ opType, CData/*7:0*/ fuType) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_LoadEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
    char index__Vcvt;
...
extern "C" void v_difftest_AtomicEvent(char coreid, svBit atomicResp, long long atomicAddr, long long atomicData, char atomicMask, char atomicFuop, long long atomicOut);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_AtomicEvent_TOP____024unit(CData/*7:0*/ coreid, CData/*0:0*/ atomicResp, QData/*63:0*/ atomicAddr, QData/*63:0*/ atomicData, CData/*7:0*/ atomicMask, CData/*7:0*/ atomicFuop, QData/*63:0*/ atomicOut) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_AtomicEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
...
extern "C" void v_difftest_PtwEvent(char coreid, svBit ptwResp, long long ptwAddr, long long ptwData_0, long long ptwData_1, long long ptwData_2, long long ptwData_3);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_PtwEvent_TOP____024unit(CData/*7:0*/ coreid, CData/*0:0*/ ptwResp, QData/*63:0*/ ptwAddr, QData/*63:0*/ ptwData_0, QData/*63:0*/ ptwData_1, QData/*63:0*/ ptwData_2, QData/*63:0*/ ptwData_3) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_v_difftest_PtwEvent_TOP____024unit\n"); );
    // Body
    char coreid__Vcvt;
    for (size_t coreid__Vidx = 0; coreid__Vidx < 1; ++coreid__Vidx) coreid__Vcvt = coreid;
    svBit ptwResp__Vcvt;
...
VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_ram_write_helper_TOP____024unit(QData/*63:0*/ wIdx, QData/*63:0*/ wdata, QData/*63:0*/ wmask, CData/*0:0*/ wen) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_ram_write_helper_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_ram_read_helper_TOP____024unit(CData/*0:0*/ en, QData/*63:0*/ rIdx, QData/*63:0*/ &ram_read_helper__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_ram_read_helper_TOP____024unit\n"); );
    // Body
    svBit en__Vcvt;
