...
extern "C" {
    ...
    // DPI import at src/test/vsrc/common/difftest.v:179:3
    ...
    // DPI import at src/test/vsrc/common/difftest.v:545:3
    ...
    // DPI import at src/test/vsrc/common/difftest.v:128:3
    ...
    extern void v_difftest_InstrCommit(char coreid, char index, svBit valid, long long pc, int instr, svBit skip, svBit isRVC, svBit scFailed, svBit wen, char wdest, long long wdata);
    // DPI import at src/test/vsrc/common/difftest.v:522:3
    extern void v_difftest_LoadEvent(char coreid, char index, svBit valid, long long paddr, char opType, char fuType);
    // DPI import at src/test/vsrc/common/difftest.v:570:3
    ...
    // DPI import at src/test/vsrc/common/difftest.v:341:3
    ...
    // DPI import at src/test/vsrc/common/difftest.v:499:3
    ...
    // DPI import at src/test/vsrc/common/difftest.v:105:3
