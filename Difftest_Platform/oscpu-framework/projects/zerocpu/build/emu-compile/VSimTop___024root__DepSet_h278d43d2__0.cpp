...
VL_INLINE_OPT void VSimTop___024root___sequent__TOP__0(VSimTop___024root* vlSelf) {
    ...
    if (vlSelf->SimTop__DOT__r_valid) {
        VSimTop___024unit____Vdpiimwrap_v_difftest_InstrCommit_TOP____024unit(0U, 0U, (IData)(vlSelf->SimTop__DOT__r_valid), (QData)((IData)(vlSelf->SimTop__DOT__r_pc)), vlSelf->SimTop__DOT__r_inst, 0U, 0U, 0U, (IData)(vlSelf->SimTop__DOT__U_inst_commit__DOT__wen), vlSelf->SimTop__DOT__U_inst_commit__DOT__wdest, vlSelf->SimTop__DOT__U_inst_commit__DOT__wdata);
    }
    if (vlSelf->reset) {
